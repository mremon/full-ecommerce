...
<html lang="en">
  ...
  <body>
    ...
    @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ url('admin/home') }}"><i class="icon ion-android-star-outline"></i> D.Footwire</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link">Product</a></li>
          <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link">Add product</a></li>
          <li class="nav-item"><a href="buttons.html" class="nav-link">Buttons</a></li>
        </ul>
        <a href="{{ route('admin.offerhandel') }}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
            <span class="menu-item-label">Offer Setting</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->  
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('all.blogpost') }}" class="nav-link">Blog Post</a></li>
          <li class="nav-item"><a href="{{ route('add.blogpost') }}" class="nav-link">Add Post</a></li>
          <li class="nav-item"><a href="{{ route('post.categtory') }}" class="nav-link">Post category</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.newslater') }}" class="nav-link">Newslate</a></li>
          <li class="nav-item"><a href="{{ route('admin.frontsetting') }}" class="nav-link">Front Setting</a></li>

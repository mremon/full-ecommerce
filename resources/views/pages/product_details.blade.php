        ...
        <div class="row">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-2 order-lg-1 order-2">
                  <ul class="image_list">
                    <li data-image="{{ asset($product->product_image_one) }}"><img src="{{ asset($product->product_image_one) }}" alt=""></li>
                    <li data-image="{{ asset($product->product_image_two) }}"><img src="{{ asset($product->product_image_two) }}" alt=""></li>
                    <li data-image="{{ asset($product->product_image_three) }}"><img src="{{ asset($product->product_image_three) }}" alt=""></li>
                  </ul>
                </div>

                <!-- Selected Image -->
                <div class="col-lg-5 order-lg-2 order-1">
                  <div class="image_selected"><img src="{{ asset($product->product_image_one) }}" alt=""></div>
                </div>
                ...
                <div class="col-lg-5 order-3">
                  <div class="product_description">
                    ...
                    <div class="rating_r rating_r_4 product_rating"> Product Code:  {{ $product->product_code }}</div>
                    <div class="product_text"><p>{!! ($product->product_short_details) !!}</p></div>
                      ...
                      <form action="{{ url('cart/product/add/'.$product->id) }}" method="post">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                             <div class="form-group">
                                <label for="">Available Size</label>
                                <select class="form-control input-lg" id="" name="size">
                        ...
                        @if($product->product_discount_price == NULL)
                            <div class="product_price">{{ $product->product_selling_price }} TK</div>
                        @else
                            <div class="product_price">{{ $product->product_discount_price }} TK</div><span style="text-decoration:line-through; margin-left:10px;">{{ $product->product_selling_price }} TK</span>
                        @endif
                        <div class="button_container">
                          <button type="submit" class="button cart_button" style="margin-top:5px;">Add to Cart</button>{{-- &nbsp<button type="submit" class="button cart_button" style="margin-top:5px;">অর্ডার সম্পূর্ণ করুণ</button> --}}
          ...
          <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#menu1">Product Others Link</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#menu2">Product Review</a>
              </li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div id="menu1" class="container tab-pane fade"><br>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <a href="{{ ($product->product_video_link) }}" target="_blank"> Product Related link</a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-6">
                    <form action="{{ route('user.review') }}" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="fullname" class="form-control" id="exampleInputName" aria-describedby="emailHelp" placeholder="Enter Your Full Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="emial" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                      </div>
